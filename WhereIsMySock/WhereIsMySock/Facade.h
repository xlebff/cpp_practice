...
public:
    ...
    */
    bool useItem(const std::vector<std::string> args);
    ...
    */
    bool combineItems(const std::vector<std::string> args);
    ...
    */
    bool lookAt(const std::string& objectName);
...
private:
    ...
    */
    bool isCommand(const std::string& curCmd);
    ...
    */
    Item* parseItem(const std::vector<std::string> args, int* index);
